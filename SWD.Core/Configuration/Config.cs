...
namespace Swd.Core.Configuration
{
    ...
    public class Config
    {
        ...
        public static string swdBrowserType
        {
            get
            {
                String tmp = ConfigurationManager.AppSettings["swdBrowserType"];
        ...
        public static string applicationUserSessionId
        {
            get
            {
                return ConfigurationManager.AppSettings["applicationUserSessionId"];
            }
        }
    }
